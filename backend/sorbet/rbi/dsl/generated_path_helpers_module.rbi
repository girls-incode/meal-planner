...
module GeneratedPathHelpersModule
  ...
  def api_v1_categories_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_ingredients_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_pantry_item_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_pantry_items_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_recipe_matches_path(*args); end
