...
This starts:
- **PostgreSQL** (port 5432) — creates `meal_planner_development` database
- **Rails backend** (port 3000) — installs gems, runs migrations, starts dev server
...
- Database: postgresql://postgres:postgres@127.0.0.1:5432/meal_planner_development
...
| --- | --- | --- | --- |
| postgres | postgres:16-alpine | 5432 | (standard) |
...
| `backend_gems` | Cache Ruby gems |
| `frontend_node_modules` | Cache npm packages |
...
- First run takes 2-3 minutes to build and run migrations
